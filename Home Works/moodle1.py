...
################################
target = 'http://localhost/webservice/rest/server.php?'
...
new_url= "http://localhost/webservice/rest/server.php?wstoken=54aa88fde406ef9d73d74e9b66103132&wsfunction=core_course_get_courses_by_field&moodlewsformat=json"
